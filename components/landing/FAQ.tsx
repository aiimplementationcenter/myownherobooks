...
export default function FAQ() {
  ...
  const qs = [
    ...
    { q: 'How long does it take to arrive?', a: 'We craft and review your book within 2 business days, then it ships and typically arrives within 5–7 days. You\'ll get a digital preview to approve before anything prints.' },
